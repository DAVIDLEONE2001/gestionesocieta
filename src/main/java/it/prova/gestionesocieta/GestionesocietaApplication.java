...
public class GestionesocietaApplication implements  CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		batteriaDiTestService.testInserisciNuovoDipendenteASocieta();
		batteriaDiTestService.testAggiornaDipendente();
		batteriaDiTestService.testTrovaDistinteSocietaConImpiegatoConRal30000();
		batteriaDiTestService.testTrovaIlPiuAnzianoConSocietaDopoIl1990();
